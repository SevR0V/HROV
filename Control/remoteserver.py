...
class RemoteUdpDataServer(asyncio.Protocol):
    ...
    def datagram_received(self, data, address):
        ...
        if not self.newRxPacket:            
            ...
            self.controlSystem.setAxisInput(self.controlSystem.ControlAxes.FORWARD, (received[UDPRxValues.FORWARD] ** 3) * 100 * self.powerTarget)
            self.controlSystem.setAxisInput(self.controlSystem.ControlAxes.STRAFE, (received[UDPRxValues.STRAFE] ** 3) * 100 * self.powerTarget)
            self.controlSystem.setAxisInput(self.controlSystem.ControlAxes.DEPTH, (received[UDPRxValues.VERTICAL] ** 3) * 100 * self.powerTarget)
            self.controlSystem.setAxisInput(self.controlSystem.ControlAxes.YAW, (received[UDPRxValues.ROTATION] ** 3) * 100 * self.powerTarget)
